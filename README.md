...
- **Linguagem/Frameworks:**
 ...
 - JavaScript (ES6+) para manipulação do DOM e consumo de API (Fetch API).
 - Tailwind CSS para estilização via classes utilitárias e animações.
 - API Charafun (Vercel) como backend para fornecimento dos dados.
